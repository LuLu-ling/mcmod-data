...
从 [Meloong-Git/PCL](https://github.com/Meloong-Git/PCL) 的 `WikiEntries.txt` 生成 `mcmod.buf`，如有变更则自动发布 release 并提交 PR 到 [PCL-CE](https://github.com/PCL-Community/PCL-CE)。
